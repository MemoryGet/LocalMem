# IClude × Codex CLI 一键集成 (Windows) / One-click integration for OpenAI Codex CLI
...
Write-Host ""
Write-Host "  IClude x Codex CLI Installer"
Write-Host "  ================================"
Write-Host ""
...
if (!(Test-Path $configFile)) {
    ...
    $configContent = @"
# IClude config - auto-generated by install.ps1
storage:
  sqlite:
    enabled: true
    path: "$dbPath"
...
if ((Test-Path $codexFile) -and (Get-Content $codexFile -Raw) -like "*iclude*") {
    ...
    if (Test-Path $codexFile) {
        ...
        $codexHeader = "# Codex CLI config - auto-generated by IClude install.ps1`n"
...
Write-Host ""
Write-Host "  Restart Codex CLI to activate IClude memory system."
