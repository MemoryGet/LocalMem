...
<p align="center">
  LocalMem combine SQLite (recherche structurée + texte intégral) et Qdrant (recherche sémantique vectorielle) pour offrir une recherche hybride à trois voies, un raisonnement LLM multi-tours, l'extraction de graphes de connaissances et l'ingestion de documents — le tout dans un seul binaire Go.
</p>
