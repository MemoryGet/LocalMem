...
<p align="center">
  LocalMem kombiniert SQLite (strukturierte + Volltextsuche) mit Qdrant (vektorbasierte semantische Suche) und bietet Drei-Wege-Hybridsuche, mehrstufiges LLM-Reasoning, Wissensgraph-Extraktion und Dokumentenaufnahme — alles in einer einzigen Go-Binary.
</p>
