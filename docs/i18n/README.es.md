...
<p align="center">
  IClude combina SQLite (búsqueda estructurada + texto completo) con Qdrant (búsqueda semántica vectorial) para proporcionar recuperación híbrida de tres vías, razonamiento LLM multi-ronda, extracción de grafos de conocimiento e ingesta de documentos — todo en un único binario Go.
</p>
