...
<p align="center">
  يجمع LocalMem بين SQLite (البحث المنظم + النص الكامل) و Qdrant (البحث الدلالي المتجهي) لتوفير استرجاع هجين ثلاثي الاتجاهات، واستدلال LLM متعدد الجولات، واستخراج رسم بياني للمعرفة، واستيعاب المستندات — كل ذلك في ملف Go ثنائي واحد.
</p>
