...
<p align="center">
  LocalMem combina SQLite (busca estruturada + texto completo) com Qdrant (busca semântica vetorial) para fornecer recuperação híbrida de três vias, raciocínio LLM multi-rodada, extração de grafos de conhecimento e ingestão de documentos — tudo em um único binário Go.
</p>
