...
<p align="center">
  LocalMem объединяет SQLite (структурированный + полнотекстовый поиск) и Qdrant (векторный семантический поиск), обеспечивая трёхканальный гибридный поиск, многоэтапное рассуждение LLM, извлечение графа знаний и загрузку документов — всё в одном бинарном файле Go.
</p>
